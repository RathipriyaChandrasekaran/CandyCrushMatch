...
var Game = function() {
	// initialize the variables during game start up
	this.init = function(size, base, ui, levelArray) {
		this.base = base;
		this.ui = ui;
    ...
    // Events to swap the candies left ,right, up and down
	...
	//auto populate the candies once they are destroyed
	...
	this.showLevelArrayInLog = function() {
	...
	this.checkLines = function() {
		...
		//checking for similar candies at all positions around
	...
	this.removeClearedGemToLevel = function(gemsToRemove) {
		...
		//remove the candies once they are matched of three
...
var startGame = function(levelArr) {
	var $game = $('#game');
	$game.find('.row').hammer().off('swipeleft swiperight swipeup swipedown');
	$game.empty();
	...
	newGame.init(value, $game, $ui, levelArr);
	return newGame;
};